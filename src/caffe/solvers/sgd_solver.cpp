...
//
// (begin) Implementing triangular learning rate (pedro)
//
	...
	if (itr > 0) {
		...
		double rate2 = this->param_.base_lr() + (this->param_.max_lr() - this->param_.base_lr()) * std::max(double(0),(1.0-fabs(x)));
...
//
// (end) Implementing triangular learning rate (pedro)
//
else {
